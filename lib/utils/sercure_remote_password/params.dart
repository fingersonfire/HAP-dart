...
final String largeSafePrime =
    ...
    '9E4AFF73';
final String generatorModulo = '02';
final String hashFunction = 'sha512';
final int hashOutputBytes = 256 ~/ 8;

class Params {
  static final N = BigInt.parse(largeSafePrime.replaceAll(' ', ''), radix: 16);
  static final g = BigInt.parse(generatorModulo, radix: 16);
  static final k = H([N, g]);
  static final int hashOutputBytes = hashOutputBytes;
